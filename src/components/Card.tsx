...
export const Card = (props: ComponentPropsWithoutRef<"div">) => {
  return (
    <div className={twMerge("relative z-0 p-8 md:p-10 group", props.className)}>
      <div
        className={twMerge(
          "absolute size-16 rounded-xl top-1.5 right-1.5 -z-10 blur-lg opacity-0 group-hover:opacity-100 transition duration-300",
          props.color === "violet" && "bg-violet-500",
          props.color === "cyan" && "bg-cyan-500",
          props.color === "lime" && "bg-lime-500",
          props.color === "fuchsia" && "bg-fuchsia-500"
        )}
      ></div>
      <div
        className={twMerge(
          "absolute size-16 rounded-xl transition duration-300 top-1.5 right-1.5 -z-10",
          props.color === "violet" && "bg-violet-500 group-hover:bg-violet-600",
          props.color === "cyan" && "bg-cyan-500 group-hover:bg-cyan-600",
          props.color === "lime" && "bg-lime-500 group-hover:bg-lime-600",
          props.color === "fuchsia" &&
